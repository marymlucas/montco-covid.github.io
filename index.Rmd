...
A very slight incrase here which is unexpected considering the initial understanding of SARS-CoV2 to be a respiratory virus
...
ggplot(tz_latest_fever_2020, aes(x=as.Date(week), y=number_of_calls_fever_2020)) +
  geom_line() + scale_x_date(date_breaks = "week") +
  theme_minimal() +
  labs(title = "911 Calls for Fever", subtitle = "Montgomery County, PA") +
  xlab("Month") +
  ylab("Number of Calls") +
...
* Montgomery County EMS Data - Compiled and provided by Mike Chirico (originally sourced from montcoalert.org)
